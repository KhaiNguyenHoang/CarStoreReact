...
public class SecurityConfig {
    ...
    public SecurityConfig(UserDetailsServiceImpl userDetailsService, CustomOAuth2UserService oauth2UserService, OAuth2AuthenticationSuccessHandler oauth2SuccessHandler) {
